...
export default function MyBook_SahayakForm ({navigation}) {
    return(
      ...
      <View style={{ justifyContent: "center", alignItems: "center", marginTop:20 }} >
                    ...
                    <View style={[styles.DateView, {display:'flex' , flexDirection:"row", justifyContent:"space-between"}]}>
                    ...
                    <View style={[styles.TimeView, {display:'flex' , flexDirection:"row", justifyContent:"space-between"}]}>
              ...
              <TouchableOpacity>
                ...
                >
                  पेंडिंग
                    ...
                    <View style={[styles.FemalecheckView,  {display: "flex",
                flexDirection: "row",
                justifyContent: "space-evenly",}]}>
                    {/* <Text style={{position:'absolute', top:-10, left:30, width:"10%", textAlign:"center", backgroundColor:'#fff'}}>लिंग:</Text> */}
                    <TextInput
