          ...
          <View style={styles.container}>
            <View style={[styles.commentContainer]}>
              ...
              <View style={{ alignItems: "center" }}>
                ...
                >
                  ...
                  शुल्क नहीं है।{"\n"}
                  <Icon name="dot-fill" size={12} /> अगली 2 बुकिंग पर अपने साथी
                  को Fawda रेफर करके,{"\n"} Fawda फीस पर 50% की छूट प्राप्त
                  करें।
                </Text>
              </View>
            </View>
            <View style={[styles.commentContainer, { marginTop: 10 }]}>
              ...
              >
                ...
                आपको रेफर कोड मीलेगा।{"\n"}
                <Icon name="dot-fill" size={13} />
                अपने किसी साथी को FAWDA के बारे में बताएं और रेफर कोड दें।
                {"\n"}
                <Icon name="dot-fill" size={13} /> जब आपके साथी की पहली बुकिंग
                पूरी होगी, तो आपको अपनी अगली बुकिंग पर FAWDA फीस पर 50% की छूट
                मिलेगी।{"\n"}
                <Icon name="dot-fill" size={13} /> इसी तरह, अपने दूसरे साथी के
                रेफर करें और एक बार फिर FAWDA फीस पर 50% छूट पाएं।
              </Text>
            </View>
